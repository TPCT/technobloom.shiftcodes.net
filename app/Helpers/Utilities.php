...
class Utilities
{
    ...
    private static function removeInlineStyle($node, &$output_style): void
    {
        foreach ($node->childNodes as $child){
            ...
            if ($node->hasChildNodes())
                Utilities::removeInlineStyle($child, $output_style);
        }
    }


    public static function view($viewPath, $content = [], $status=200, $headers=[]): bool|\Illuminate\Http\JsonResponse|string
    {
        ...
        libxml_clear_errors();
        $style = "";
        Utilities::removeInlineStyle($html->getElementsByTagName('body')->item(0), $style);
